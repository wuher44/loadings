...
<div style="text-align: center">
    <fieldset style="background-color: rgba(5, 17, 43, 0.7); width: 400px; color: red; display: inline-block;">
        <legend>Set unload</legend>
        <form method="post" action="/loading/setUnload/${loading.id}">
            <label>Start of
                unload: </label><input type="datetime-local" name="startOfUnload" value="${loading.startOfUnload}"><br><br>
            <label>End of
                unload: </label><input type="datetime-local" name="endOfUnload" value="${loading.endOfUnload}">
            <p style="color: red">${info}</p><br><br>
